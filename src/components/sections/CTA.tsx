...
export default function CTA({ title, subtitle, ctaLabel, ctaHref }: CTAProps) {
  return (
    <Section background="default" spacing="none" id="cta" className="py-[80px]">
      <Reveal direction="up">
        {/* Inside Container Info: width 1280, height 464, pt 80, pb 80, radius 40px, bg gradient */}
        <div
          className="relative mx-auto flex h-auto min-h-[464px] max-w-[1280px] flex-col items-center justify-center overflow-hidden rounded-[40px] px-6 py-[80px] text-center text-white md:px-[80px]"
          style={{
